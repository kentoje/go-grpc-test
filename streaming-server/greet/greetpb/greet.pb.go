...
// 	protoc        v3.12.0
// source: streaming-server/greet/greetpb/greet.proto
...
func (x *Greeting) Reset() {
	*x = Greeting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_server_greet_greetpb_greet_proto_msgTypes[0]
...
func (*Greeting) Descriptor() ([]byte, []int) {
	return file_streaming_server_greet_greetpb_greet_proto_rawDescGZIP(), []int{0}
}
...
func (x *GreetManyTimesRequest) Reset() {
	*x = GreetManyTimesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_server_greet_greetpb_greet_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetManyTimesRequest) Descriptor() ([]byte, []int) {
	return file_streaming_server_greet_greetpb_greet_proto_rawDescGZIP(), []int{1}
}
...
func (x *GreetManyTimesResponse) Reset() {
	*x = GreetManyTimesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streaming_server_greet_greetpb_greet_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetManyTimesResponse) Descriptor() ([]byte, []int) {
	return file_streaming_server_greet_greetpb_greet_proto_rawDescGZIP(), []int{2}
}
...
var File_streaming_server_greet_greetpb_greet_proto protoreflect.FileDescriptor

var file_streaming_server_greet_greetpb_greet_proto_rawDesc = []byte{
	0x0a, 0x2a, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x2d, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62,
	...
	0x09, 0x52, 0x08, 0x6c, 0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x44, 0x0a, 0x15, 0x47,
	...
	0x75, 0x6c, 0x74, 0x32, 0x61, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x51, 0x0a, 0x0e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79,
...
var (
	file_streaming_server_greet_greetpb_greet_proto_rawDescOnce sync.Once
	file_streaming_server_greet_greetpb_greet_proto_rawDescData = file_streaming_server_greet_greetpb_greet_proto_rawDesc
)

func file_streaming_server_greet_greetpb_greet_proto_rawDescGZIP() []byte {
	file_streaming_server_greet_greetpb_greet_proto_rawDescOnce.Do(func() {
		file_streaming_server_greet_greetpb_greet_proto_rawDescData = protoimpl.X.CompressGZIP(file_streaming_server_greet_greetpb_greet_proto_rawDescData)
	})
	return file_streaming_server_greet_greetpb_greet_proto_rawDescData
}

var file_streaming_server_greet_greetpb_greet_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_streaming_server_greet_greetpb_greet_proto_goTypes = []interface{}{
...
var file_streaming_server_greet_greetpb_greet_proto_depIdxs = []int32{
...
func init() { file_streaming_server_greet_greetpb_greet_proto_init() }
func file_streaming_server_greet_greetpb_greet_proto_init() {
	if File_streaming_server_greet_greetpb_greet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_streaming_server_greet_greetpb_greet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_server_greet_greetpb_greet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_server_greet_greetpb_greet_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_streaming_server_greet_greetpb_greet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_streaming_server_greet_greetpb_greet_proto_goTypes,
		DependencyIndexes: file_streaming_server_greet_greetpb_greet_proto_depIdxs,
		MessageInfos:      file_streaming_server_greet_greetpb_greet_proto_msgTypes,
	}.Build()
	File_streaming_server_greet_greetpb_greet_proto = out.File
	file_streaming_server_greet_greetpb_greet_proto_rawDesc = nil
	file_streaming_server_greet_greetpb_greet_proto_goTypes = nil
	file_streaming_server_greet_greetpb_greet_proto_depIdxs = nil
}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "streaming-server/greet/greetpb/greet.proto",
}
